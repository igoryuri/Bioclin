        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center text-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    {{__('welcome.distribuidores')}} Bioclin
                </h3>
            ...
            <div class="p-4 md:p-5 space-y-4 flex justify-center items-center">
                <iframe src="https://www.google.com/maps/d/embed?mid=1Kt9F7m9McnoXGCayYN-PDKQfUPsliY4&ehbc=2E312F" width="640" height="480"></iframe>
            </div>
