...
<div class="flex flex-col justify-center items-center">
    <div class="w-full md:w-2/3 mx-auto mt-6 h-fit">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow">
            <!-- Modal header -->
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h1 class="text-2xl md:text-4xl font-semibold text-bioclin ">
                    {{__('welcome.contatos')}}
                </h1>
            </div>
            <!-- Modal body -->
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select id="sector" name="sector"
                            ...
                            <option value="sac">{{__('welcome.sac_contact')}}</option>
                            <option value="rh">{{__('welcome.rh_contact')}}</option>
                            <option value="vendas">{{__('welcome.comercial_contact')}}</option>
                            <option value="grp-comex">{{__('welcome.comex_contact')}}</option>
                            <option value="igor.silva">Igor</option>
                        </select>
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <p class="mt-1 text-sm text-gray-500" id="file_input_help">PDF, DOC, DOCX,
                            ODT, TXT (Max 15Mb).</p>
                    </div>
                    <div class="col-span-2">
